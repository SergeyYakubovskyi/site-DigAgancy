(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".feedback__slider")) new swiper_core_Swiper(".feedback__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".feedback-button__prev ",
                nextEl: ".feedback-button__next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const dropLists = document.querySelectorAll(".menu__link--dropdown");
        dropLists.forEach((function(dropList) {
            dropList.addEventListener("click", (function(e) {
                const submenu = dropList.nextElementSibling;
                if (submenu.classList.contains("_active")) {
                    submenu.classList.remove("_active");
                    dropList.querySelector(".menu__link-arrow").classList.remove("_active");
                } else {
                    const allSubmenus = document.querySelectorAll(".menu__submenu");
                    allSubmenus.forEach((function(otherSubmenu) {
                        otherSubmenu.classList.remove("_active");
                        otherSubmenu.previousElementSibling.querySelector(".menu__link-arrow").classList.remove("_active");
                    }));
                    submenu.classList.add("_active");
                    dropList.querySelector(".menu__link-arrow").classList.add("_active");
                }
                e.stopPropagation();
            }));
        }));
        document.addEventListener("click", (function(e) {
            ...
            allSubmenus.forEach((function(submenu) {
                submenu.classList.remove("_active");
                submenu.previousElementSibling.querySelector(".menu__link-arrow").classList.remove("_active");
            }));
        }));
    }));
    Splitting();
    ...
    gsap.from(".col__sublable", {
        scrollTrigger: {
            trigger: ".col__sublable",
            start: "top 100%",
            end: "70% 80%",
            toggleActions: "play none none none"
        },
